...
#-----------------------------------------------------------------------------
vendor_remove_dirs := tts media/audio
...
vendor_saved_apps := Bluetooth KeyChain HTMLViewer UserDictionaryProvider BackupRestoreConfirmation \
                     ...
                     ProxyHandler Shell DefaultContainerService BluetoothExt Stk
...
override_property += \
    ro.flyme.romer=Air-LOVE \
    ro.product.device=aries \
    ro.product.model_romer=MI-2S_Air-LOVE \
